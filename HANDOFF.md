...
└── pupbar.html       ─ DELETED (was an old redundant page)
```
...
- **Responsive:** Breakpoints at 1024px, 900px, 768px, 640px, 480px
...
7. **Performance** — Consider lazy-loading off-screen sections, image optimization
